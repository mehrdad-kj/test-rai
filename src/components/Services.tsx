...
const Services = () => {
  ...
  return (
    <div id="SERVICES" className="w-full h-[70%] bg-sky-950 text-[#C3CEDA] py-10">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full mt-10">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          {images.map((image) => (
            <div
              key={image.alt}
              className="shadow-md shadow-[#040c16] hover:scale-110 transition-all ease-in-out duration-500"
            >
              <img
